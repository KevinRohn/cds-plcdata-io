...
class ScriptGitMergeOptions(object):
	"""
	| Wrapper around _3S.CoDeSys.Git.GitIntegration.IGitMergeOptions.
	...
	def use_auto_merger(self) -> bool:
		...
		| These are only applied, if "resolve_file_conflict_strategy" is set to "GitResolveFileConflictStrategy.Normal".
